    ...
    public function test_orchid_admin_can_manage_public_website_records(): void
    {
        ...
        $this->actingAs($admin)
            ->post(route('platform.website.courses.edit', ['program' => $program, 'method' => 'save']), [
                ...
                'is_featured' => '0',
                'name_translations' => ['ru' => 'Категория B Block 1', 'en' => 'Category B Block 1'],
                ...
                'includes_translations' => ['ru' => 'Теория и практика', 'en' => 'Theory and practice'],
                'excludes_translations' => ['ru' => 'Дополнительные часы отдельно', 'en' => 'Extra hours separately'],
                'requirements_translations' => ['ru' => 'Минимальный возраст', 'en' => 'Minimum age'],
                'program_summary_translations' => ['ru' => 'Теория ПДД', 'en' => 'Traffic theory'],
