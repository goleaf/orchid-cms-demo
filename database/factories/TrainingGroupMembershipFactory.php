...
class TrainingGroupMembershipFactory extends Factory
{
    ...
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Invited->value, 'joined_at' => null, 'left_at' => null]);
    }

    public function pending(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Pending->value, 'joined_at' => null, 'left_at' => null]);
    }

    public function active(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Active->value, 'left_at' => null]);
    }

    public function left(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Left->value, 'left_at' => now(), 'left_reason' => 'cancelled']);
    }

    public function waitlisted(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Waitlisted->value]);
    }

    public function transferred(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Transferred->value, 'left_at' => now(), 'transfer_reason' => 'group_changed']);
    }

    public function completed(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Completed->value, 'left_at' => now()]);
    }

    public function removed(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Removed->value, 'left_at' => now(), 'left_reason' => 'removed']);
    }

    public function cancelled(): static
    {
        return $this->state(fn (): array => ['status' => TrainingGroupMembershipStatus::Cancelled->value, 'left_at' => now(), 'left_reason' => 'cancelled']);
    }
