...
class CourseFactory extends Factory
{
    ...
    public function translated(): static
    {
        return $this->state(fn (array $attributes): array => [
            ...$this->categoryBContent(),
            'canonical_url' => url('/courses/'.($attributes['slug'] ?? 'category-b-manual')),
        ]);
    }
    ...
    {
        return $this->state(fn (): array => ['format' => CourseFormat::Online->value]);
    }

    public function offline(): static
    {
        return $this->state(fn (): array => ['format' => CourseFormat::Offline->value]);
    }

    public function hybrid(): static
    {
        return $this->state(fn (): array => ['format' => CourseFormat::Hybrid->value]);
    }

    public function group(): static
    {
        return $this->state(fn (): array => ['format' => CourseFormat::Group->value]);
    }

    public function individual(): static
    {
        return $this->state(fn (): array => ['format' => CourseFormat::Individual->value]);
    }
