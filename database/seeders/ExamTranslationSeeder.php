...
class ExamTranslationSeeder extends SystemTranslationSeeder
{
    ...
    private function entries(): array
    {
        return [
            ...
            $this->entry('exams', 'exams.columns.program', ['ru' => 'Программа', 'en' => 'Program', 'lt' => 'Programa', 'pl' => 'Program']),
            ...
            $this->entry('exams', 'exams.columns.status', ['ru' => 'Статус', 'en' => 'Status', 'lt' => 'Busena', 'pl' => 'Status']),
