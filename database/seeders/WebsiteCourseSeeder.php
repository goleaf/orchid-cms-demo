            ...
            $payload = $factory
                ->make([
                    ...
                    'short_description_translations' => [
                        'ru' => 'Демо-курс автошколы. TODO: review copy with a human translator.',
                        'en' => 'Demo driving school course. TODO: review copy with a human translator.',
                        'lt' => 'Demonstracinis vairavimo kursas. TODO: review copy with a human translator.',
                        'pl' => 'Przykladowy kurs jazdy. TODO: review copy with a human translator.',
                    ],
                    'description_translations' => [
                        'ru' => 'Публичное описание курса для сайта автошколы.',
                        'en' => 'Public course description for the driving school website.',
                        'lt' => 'Viesas kurso aprasymas vairavimo mokyklos svetainei.',
                        'pl' => 'Publiczny opis kursu dla strony szkoly jazdy.',
                    ],
