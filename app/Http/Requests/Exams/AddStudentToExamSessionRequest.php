...
class AddStudentToExamSessionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'student_id' => ['required', 'integer', Rule::exists(Student::class, 'id'), new StudentActiveForExamRule, new StudentCanJoinExamSessionRule($session, $enrollment, $this->boolean('allow_overbooking'))],
            'enrollment_id' => ['required', 'integer', Rule::exists(StudentEnrollment::class, 'id'), new EnrollmentActiveForExamRule],
