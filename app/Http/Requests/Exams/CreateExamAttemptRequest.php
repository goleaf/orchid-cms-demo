...
class CreateExamAttemptRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'student_id' => ['required', 'integer', Rule::exists(Student::class, 'id'), new StudentActiveForExamRule],
            'enrollment_id' => ['required', 'integer', Rule::exists(StudentEnrollment::class, 'id'), new EnrollmentActiveForExamRule, new EnrollmentCanTakeExamRule($session?->type_id)],
