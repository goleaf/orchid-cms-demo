...
class EnrollmentCanTakeExamRule implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        try {
            if ($enrollment !== null && app(ExamWorkflowService::class)->enrollmentCanTakeExam($enrollment, $this->type)) {
                return;
            }
        } catch (Throwable) {
        }

        $fail(tkey('exams.validation.enrollment_cannot_take_exam'));
    }
}
